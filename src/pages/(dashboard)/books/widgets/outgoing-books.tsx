...
import { useOutgoingBooks } from '@/pages/(dashboard)/books/models/use-outgoing-books';
import {
	Card,
	CardHeader,
	CardContent,
...
import { ShareDialog } from '@/pages/(dashboard)/books/components'
...
export const OutgoingBooksWidgets = () => {
	const {
		isError,
		isFetching,
		isLoading,
